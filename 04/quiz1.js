...
var page = 1;
var onePageImage = 3; // 한번에 보일 갯수
var totalPage = Math.ceil(todayPhoto.length / onePageImage); // 소숫점 올림

var $wrap = document.getElementById('wrap');
var $btnPrev = document.querySelector('.btn_prev');
var $btnNext = document.querySelector('.btn_next');
var $page = document.querySelector('.page');
var $totalPage = document.querySelector('.total_page');
...
function getStartIndex(page) {
    ...
    var startIndex = (page - 1) *onePageImage;
    return startIndex;
}
...
function printImg(page) {
    ...
    var str = '';
    for(var i=startIndex; i<startIndex + onePageImage; i++){
        if(todayPhoto[i]){
